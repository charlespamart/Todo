...
namespace Todo.Domain.TestHelpers
{
    public static class TestHelpers
    {
        ...
        public static readonly IImmutableList<TodoTask> TodoTasksCompleted = new List<TodoTask>
            {
                new TodoTask(Guid, "Todotask 0", true, 0),
                new TodoTask(new Guid("00000000-0000-0000-0000-000000000002"), "Todotask 1", true, 1),
                new TodoTask(new Guid("00000000-0000-0000-0000-000000000003"), "Todotask 2", true, 2),
                new TodoTask(new Guid("00000000-0000-0000-0000-000000000004"), "Todotask 3", true, 3),
            }.ToImmutableList();
